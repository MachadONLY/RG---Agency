        ...
        <div className='mx-auto max-w-[1240px] w-full h-full p-2'>
            <div className='flex my-32 flex-col justify-center items-center lg:flex-row gap-12'>
                <div className='flex flex-col gap-6 lg:w-[50%] w-[85%]'>
                    ...
                    <p className='text-2xl font-bold text-justify my-2'>Nós ajudamos você a conectar sua marca ao sucesso, <span className='text-zinc-500'> pare de desperdiçar tempo e dinheiro</span> em campanhas publicitárias falhas e ineficazes</p>
                    <Link href="/">
